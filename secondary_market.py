...
candidate_database = {
    "1 Hotel Toronto": ["1 Hotel Toronto", "0xaC8eB8B2ed5C4a0fC41a84Ee4950F417f67029F0", "4.3", .20, "Images/1 Hotel Toronto.jpeg"],
...
st.markdown("# Hotel Rooms on Blockchain!")
...
hotel = st.sidebar.text_input('Sell your hotel shares (list your hotel token below)')
...
candidate = candidate_database[hotel][0]

# Write the Fintech Finder candidate's name to the sidebar
st.sidebar.write(candidate)

# Identify the FinTech Finder candidate's Daily rate
hourly_rate = candidate_database[hotel][3]

# Write the inTech Finder candidate's Daily rate to the sidebar
st.sidebar.write(hourly_rate)

# Identify the FinTech Finder candidate's Ethereum Address
candidate_address = candidate_database[hotel][1]

# Write the inTech Finder candidate's Ethereum Address to the sidebar
st.sidebar.write(candidate_address)

st.sidebar.markdown("seller's Ethereum Balance in Ether")

# Write the inTech Finder candidate's Ethereum balance to the sidebar
st.sidebar.write(get_balance(w3,candidate_address))

# Write the Fintech Finder candidate's name to the sidebar

st.sidebar.markdown("## Total Proceeds in Ether")
...
# worker will be paid in ether. To do so, complete the following steps:
    ...
    # * Write the equation that calculates the ca ndidate’s wage. This equation
    #  should assess the candidate’s Daily rate from the candidate database
    # (`candidate_database[hotel][3]`) and then multiply this Daily rate by
...
# rate from the candidate database (`candidate_database[hotel][3]`) by the
# value of the `hours` variable
# YOUR CODE HERE
wage = candidate_database[hotel][3] * hours
...
# from the appropriate drop-down menu. Then, enter the number of days that you
